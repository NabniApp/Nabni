...
class EditcontractorProfileScreen extends StatefulWidget {
  UserModel model;
  EditcontractorProfileScreen({Key? key, required this.model})
      : super(key: key);
  @override
...
class _EditContractorProfileScreenState
  ...
  TextEditingController _licenceNumController = new TextEditingController();
  ...
  void _update(AuthController authController) async {
    ...
    String _licenceNum = _licenceNumController.text.trim();
    String _commercialRegister = _commercialRegisterController.text.trim();
    String _bioRegister = _companyBioController.text.trim();
