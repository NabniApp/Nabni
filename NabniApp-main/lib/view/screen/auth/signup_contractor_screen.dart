...
class SignUpContractorScreen extends StatefulWidget {
  const SignUpContractorScreen({Key? key}) : super(key: key);

  @override
  _SignUpContractorScreenState createState() => _SignUpContractorScreenState();
}

class _SignUpContractorScreenState extends State<SignUpContractorScreen> {
  TextEditingController usernameController = new TextEditingController();
  TextEditingController emailController = new TextEditingController();
  TextEditingController phoneController = new TextEditingController();
  TextEditingController idController = new TextEditingController();
  TextEditingController passController = new TextEditingController();
  TextEditingController licenceNumController = new TextEditingController();
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            //     children: [
            //       Icon(Icons.add_a_photo, color: Color(0xFF8B7C61), size: 20),
            //       SizedBox(height: 30),
            //       Text(
            //         'صورة شخصية (اختيارية)',
            //         style: TextStyle(
            ...
            TextField(
              ...
              decoration: InputDecoration(
                contentPadding: EdgeInsets.symmetric(vertical: 6),
                prefixIcon:
                    Icon(Icons.card_travel, color: Color(0xFF8B7C61), size: 18),
                filled: true,
                fillColor: Color(0xFFFEFDF9),
                hintText: 'أدخل رقم الرخصة المهنية',
                border: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(5),
                  borderSide: BorderSide(color: Color(0x1E15172B), width: 1),
                ),
            ...
            TextField(
              ...
              decoration: InputDecoration(
                  ...
                  border: OutlineInputBorder(),
                  prefixIcon:
                      Icon(Icons.message, color: Color(0xFF8B7C61), size: 18)),
            ),
            const SizedBox(
              height: 10,
            ),
  ...
  void _register(AuthController authController) async {
    ...
    String licenceNum = licenceNumController.text.trim();
    String commercialRegister = commercialRegisterController.text.trim();
        ...
        await authController.uploadImage(image!).then((image_url) async {
          authController
              .userRegister(context,
                  ...
                  user_type: AppConstants.userTypes[1],
                  phone: _number,
                  bio: bioRegister,
                  identity: identity,
                  email: _email,
