...
class SignUpSupplierScreen extends StatefulWidget {
  const SignUpSupplierScreen({Key? key}) : super(key: key);

  @override
  _SignUpSupplierScreenState createState() => _SignUpSupplierScreenState();
}

class _SignUpSupplierScreenState extends State<SignUpSupplierScreen> {
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  prefixIcon: Icon(Icons.card_travel,
                      color: Color(0xFF8B7C61), size: 18),
                  filled: true,
                  fillColor: Color(0xFFFEFDF9),
